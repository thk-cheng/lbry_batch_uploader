...
class TestGetFileNameNoExtClean:
    def test_alphabet_number_half(self):
        file_name_no_ext = "ABCDEF123456" + "!@#$%^&*()+=}{|:;'<,>?/" + '"' + "\\"
        file_name_no_ext_clean = "ABCDEF123456"
        assert get_file_name_no_ext_clean(file_name_no_ext) == file_name_no_ext_clean

    def test_alphabet_number_full(self):
        file_name_no_ext = "ABCDEF123456" + \
                            """！％……＊（）——『〖｛「【〔［ \
                                〚〘』〗｝」】〕］〛〙·・｜、\
                                ＼：；“‘《〈，》〉。？"""
    ...
    def test_alphabet_number_half_full(self):
        file_name_no_ext = "ABCDEF123456" + "!@#$%^&*()+=}{|:;'<,>?/" + '"' + "\\" + \
                            """！％……＊（）——『〖｛「【〔［ \
                                〚〘』〗｝」】〕］〛〙·・｜、\
                                ＼：；“‘《〈，》〉。？"""
